...
<div id="popup_wrapper">
    {if !$this->session->userdata('user_id')}
        <div id="popup-login" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
             aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-login clearfix">
                            <li><a href="javascript:void(0);" class="login-zing" title="Đăng nhập bằng Zing ID">Zing
                                    ID</a></li>
                            <li><a href="javascript:void(0);" class="login-facebook" title="Đăng nhập bằng Facebook">Facebook</a>
                            </li>
                            <li><a href="javascript:void(0);" class="login-google"
                                   title="Đăng nhập bằng Google">Google</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        </div>
        <div id="url-popup" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true">
    ...
    {/if}
    <div id="popup-alert" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-sm" style="width:400px">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div id="popup-confirm" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-sm" style="width:400px">
            <div class="modal-content">
                <div class="modal-header">
